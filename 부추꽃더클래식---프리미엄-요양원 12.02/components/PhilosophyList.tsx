        ...
        <div className="w-full md:w-2/3">
          {items.map((item, index) => (
            <div 
              ...
              className="min-h-screen flex flex-col justify-center p-6 md:p-24 border-b border-white/5 relative overflow-hidden group"
            >
              ...
              <div className="absolute inset-0 z-0">
                ...
                />
                 <div className="absolute inset-0 bg-gradient-to-t from-stone-900 via-stone-900/80 to-stone-900/20"></div>
              </div>
              ...
              <div className="relative z-10 max-w-3xl mt-20 md:mt-0">
                 ...
                 <div className="bg-black/40 backdrop-blur-sm p-6 md:p-8 rounded-lg border-l-4 border-stone-500">
